"""
batball.py Minigame Paddle Ball.

Copied from "BAT AND BALL" By antiloquax 28th April 2012, MagPi Issue #1
Bat and Ball is also called Paddleball in some sources.

Created on Sat Oct 30 10:48:00 2021
...
pygame.display.set_caption("Bat & Ball")
...
while done == 0:
    ...
    for event in pygame.event.get():  # if we click something ...
        ...
        if ballrect.top > size[1]:
            ...
            ballrect.top = 0;
            ballrect.left = (size[0]/2)   # reset the ball position
